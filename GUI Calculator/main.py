...
def evaluate_calculation():
    global calculation
    try:
        calculation = str(eval(calculation)) # eval function is not safe and have security issues
        text_result.delete(1.0, "end")
        text_result.insert(1.0, calculation)
    except:
        clear_field()
...
# Add Plus, Minus, Multiply, Divide buttons
...
# Add open close parentheses and equal buttons
